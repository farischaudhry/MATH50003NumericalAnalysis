...
\]
where $|\ensuremath{\delta}| \ensuremath{\leq}  22 \ensuremath{\epsilon}_{\rm m}.$ First we find
\meeq{
...
\[
|\ensuremath{\delta}_4| \ensuremath{\leq} (2+2+3+1+1) {\ensuremath{\epsilon}_{\rm m} \over 2} = 5\ensuremath{\epsilon}_{\rm m}.
\]
...
\[
|\ensuremath{\delta}| \ensuremath{\leq} 2 (5 +  2 + 2 + 1/4 + 1/4 + 3/4 + 1/8) \ensuremath{\epsilon}_{\rm m} \ensuremath{\leq} 22 \ensuremath{\epsilon}_{\rm m}
\]
\end{example}
